    ...
    >
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex justify-start pt-10 md:pt-40 md:gap-0 relative"
          >
            <div className="absolute sm:sticky flex flex-col md:flex-row z-40 items-center top-10 sm:top-40 self-start max-w-xs lg:max-w-xs md:w-full">
